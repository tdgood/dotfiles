...
vim.o.winborder = "rounded" -- window border
...
vim.keymap.set("n", "<leader>pc", ":lua vim.pack.update(nil, { offline = true })<CR>", { desc = "Package check" })
vim.keymap.set("n", "<leader>pu", ":lua vim.pack.update(nil, { force = true })<CR>", { desc = "Package update" })
...
-- update treesitter parsers when treesitter package is updated
